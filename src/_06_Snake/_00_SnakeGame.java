...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Don't run the snake into the wall, or his own tail: you die.\n"
	...
	private void setFoodLocation() {
		...
		int randW = rW.nextInt(WINDOW_WIDTH);
		Random rH = new Random();
		int randH = rH.nextInt(WINDOW_HEIGHT);
		Location l = new Location(randW, randH);
	...
	private void gameOver() {
		...
		String PA = JOptionPane.showInputDialog("Play Again? (Yes/No)");
